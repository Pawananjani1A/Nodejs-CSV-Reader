...
router.get('/', function (req, res, next) {
  res.render('index', { title: 'Nodejs CSV Parser',data:books,mg:magazines,auth:authors });
});

router.get('/books', function (req, res, next) {
  uploadData();
  res.render('index', { title: 'Nodejs CSV Parser',data:books,mg:null,auth:null});
});

router.get('/magazines', function (req, res, next) {
  uploadData();
  res.render('index', { title: 'Nodejs CSV Parser',mg:magazines,data:null,auth:null});
});

router.get('/authors', function (req, res, next) {
  res.render('index', { title: 'Nodejs CSV Parser',auth:authors,data:null,mg:null });
});
